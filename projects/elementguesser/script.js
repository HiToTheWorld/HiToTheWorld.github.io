const elements = [
    ...
    { name: "oxygen", symbol: "o", atomicNumber: 8, state: "gas", metal: "nonmetal", classList: [], atomicMass: 0 },
    { name: "fluorine", symbol: "f", atomicNumber: 9, state: "gas", metal: "nonmetal", classList: ["halogen"], atomicMass: 0 },
    { name: "neon", symbol: "ne", atomicNumber: 10, state: "gas", metal: "nonmetal", classList: ["noble gas"], atomicMass: 0 },
    { name: "sodium", symbol: "na", atomicNumber: 11, state: "solid", metal: "metal", classList: ["alkali"], atomicMass: 0 },
    { name: "magnesium", symbol: "mg", atomicNumber: 12, state: "solid", metal: "metal", classList: ["alkaline"], atomicMass: 0 },
    { name: "aluminum", symbol: "al", atomicNumber: 13, state: "solid", metal: "metal", classList: ["inner transition metal"], atomicMass: 0 },
    { name: "silicon", symbol: "si", atomicNumber: 14, state: "solid", metal: "metalloid", classList: [], atomicMass: 0 },
    { name: "phosphorus", symbol: "p", atomicNumber: 15, state: "solid", metal: "nonmetal", classList: [], atomicMass: 0 },
    { name: "sulfur", symbol: "s", atomicNumber: 16, state: "solid", metal: "nonmetal", classList: [], atomicMass: 0 },
    { name: "chlorine", symbol: "cl", atomicNumber: 17, state: "gas", metal: "nonmetal", classList: ["halogen"], atomicMass: 0 },
    { name: "argon", symbol: "ar", atomicNumber: 18, state: "gas", metal: "nonmetal", classList: ["noble gas"], atomicMass: 0 },
    { name: "potassium", symbol: "k", atomicNumber: 19, state: "solid", metal: "metal", classList: ["alkali"], atomicMass: 0 },
    { name: "calcium", symbol: "ca", atomicNumber: 20, state: "solid", metal: "metal", classList: ["alkaline"], atomicMass: 0 },
    { name: "scandium", symbol: "sc", atomicNumber: 21, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "titanium", symbol: "ti", atomicNumber: 22, state: "solid", metal: "metal", classList: [], atomicMass: 0 },
    { name: "vanadium", symbol: "v", atomicNumber: 23, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    ...
    { name: "technetium", symbol: "tc", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    ...
    { name: "promethium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["lanthanide"], atomicMass: 0 },
    ...
    { name: "holmiun", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["lanthanide"], atomicMass: 0 },
    ...
    { name: "bismuth", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["inner transition metal"], atomicMass: 0 },
    { name: "polonium", symbol: "", atomicNumber: 0, state: "solid", metal: "metalloid", classList: [], atomicMass: 0 },
    { name: "astatine", symbol: "", atomicNumber: 0, state: "solid", metal: "metalloid", classList: ["halogen"], atomicMass: 0 },
    { name: "radon", symbol: "", atomicNumber: 0, state: "gas", metal: "nonmetal", classList: [], atomicMass: 0 },
    { name: "francium", symbol: "fr", atomicNumber: 87, state: "solid", metal: "metal", classList: ["alkali"], atomicMass: 0 },
    { name: "radium", symbol: "", atomicNumber: 88, state: "solid", metal: "metal", classList: ["alkaline"], atomicMass: 0 },
    { name: "actinium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "thorium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "protactinium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "uranium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "neptunium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "plutonium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "americium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "curium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "berkelium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "californium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "einsteinium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "fermium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "mendelevium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "nobelium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "lawrencium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["actinide"], atomicMass: 0 },
    { name: "rutherfordium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "dubnium", symbol: "", atomicNumber: 0, state: "", metal: "", classList: ["transition metal"], atomicMass: 0 },
    { name: "seaborgium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "bohrium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "hassium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "meitnerium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "darmstadium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "roentgenium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "copernicium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["transition metal"], atomicMass: 0 },
    { name: "nihonum", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["inner transition metal"], atomicMass: 0 },
    { name: "flerovium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["inner transition metal"], atomicMass: 0 },
    { name: "moscovium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["inner transition metal"], atomicMass: 0 },
    { name: "livermorium", symbol: "", atomicNumber: 0, state: "solid", metal: "metal", classList: ["inner transition metal"], atomicMass: 0 },
    { name: "tennessine", symbol: "", atomicNumber: 0, state: "solid", metal: "metalloid", classList: ["halogen"], atomicMass: 0 },
    { name: "oganesson", symbol: "", atomicNumber: 0, state: "gas", metal: "nonmetal", classList: ["noble gas"], atomicMass: 0 },
]
