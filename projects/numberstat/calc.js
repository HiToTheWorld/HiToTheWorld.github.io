...
print.addEventListener('click', function() {
  if (arrayresult.length != 0) {
    window.open("https://numberstat.rabitailleow.repl.co/print/?arr=" + arrayresult)
  }
})

share.addEventListener('click', function() {
  if (arrayresult.length != 0) {
    window.open("mailto:?body=https://numberstat.rabitailleow.repl.co/link/?arr=" + arrayresult)
  }
})